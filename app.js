...
var TEAMS = {
  ARK:{name:"Arkansas",primary:"#9D2235",secondary:"#000000"},
  UGA:{name:"Georgia",primary:"#BA0C2F",secondary:"#000000"},
  KENT:{name:"Kent State",primary:"#002664",secondary:"#EAAB00"},
  OSU:{name:"Ohio State",primary:"#BB0000",secondary:"#666666"},
  BUFF:{name:"Buffalo",primary:"#005BBB",secondary:"#000000"},
  PSU:{name:"Penn State",primary:"#041E42",secondary:"#FFFFFF"},
  UNI:{name:"N. Iowa",primary:"#4B116F",secondary:"#FFCB05"},
  IOWA:{name:"Iowa",primary:"#000000",secondary:"#FFCD00"},
  TROY:{name:"Troy",primary:"#8A2432",secondary:"#B4975A"},
  MIZ:{name:"Missouri",primary:"#000000",secondary:"#F1B82D"},
  MSU:{name:"Michigan St.",primary:"#18453B",secondary:"#FFFFFF"},
  ND:{name:"Notre Dame",primary:"#0C2340",secondary:"#C99700"},
  LSU:{name:"LSU",primary:"#461D7C",secondary:"#FDD023"},
  MISS:{name:"Ole Miss",primary:"#14213D",secondary:"#CE1126"},
  CSU:{name:"Colorado St.",primary:"#1E4D2B",secondary:"#C8C372"},
  BYU:{name:"BYU",primary:"#002E5D",secondary:"#FFFFFF"},
  UNM:{name:"New Mexico",primary:"#BA0C2F",secondary:"#A7A8AA"},
  OU:{name:"Oklahoma",primary:"#841617",secondary:"#FDF9D8"},
  WVU:{name:"West Virginia",primary:"#002855",secondary:"#EAAA00"},
  UVA:{name:"Virginia",primary:"#232D4B",secondary:"#E57200"},
  AUB:{name:"Auburn",primary:"#03244D",secondary:"#DD550C"},
  FLA:{name:"Florida",primary:"#0021A5",secondary:"#FA4616"},
  WAKE:{name:"Wake Forest",primary:"#9E7E38",secondary:"#000000"},
  MIA:{name:"Miami",primary:"#F47321",secondary:"#005030"},
  HOU:{name:"Houston",primary:"#C8102E",secondary:"#FFFFFF"},
  TTU:{name:"Texas Tech",primary:"#CC0000",secondary:"#000000"},
  PORT:{name:"Portland St.",primary:"#006A44",secondary:"#FFFFFF"},
  ORE:{name:"Oregon",primary:"#154733",secondary:"#FEE123"},
  UK:{name:"Kentucky",primary:"#0033A0",secondary:"#FFFFFF"},
  TAMU:{name:"Texas A&M",primary:"#500000",secondary:"#FFFFFF"},
  FSU:{name:"Florida State",primary:"#782F40",secondary:"#CEB888"},
  ALA:{name:"Alabama",primary:"#9E1B32",secondary:"#FFFFFF"},
  USC:{name:"USC",primary:"#990000",secondary:"#FFC72C"},
  RUTG:{name:"Rutgers",primary:"#CC0033",secondary:"#FFFFFF"},
  SMU:{name:"SMU",primary:"#C8102E",secondary:"#354CA1"},
  LOU:{name:"Louisville",primary:"#AD0000",secondary:"#000000"},
  USU:{name:"Utah State",primary:"#0F2439",secondary:"#FFFFFF"},
  UTAH:{name:"Utah",primary:"#CC0000",secondary:"#000000"},
  UTEP:{name:"UTEP",primary:"#FF8200",secondary:"#041E42"},
  MICH:{name:"Michigan",primary:"#00274C",secondary:"#FFCB05"},
  WKU:{name:"W. Kentucky",primary:"#C8102E",secondary:"#FFFFFF"},
  IU:{name:"Indiana",primary:"#990000",secondary:"#FFFFFF"},
  KENN:{name:"Kennesaw St.",primary:"#000000",secondary:"#FDBB30"},
  TENN:{name:"Tennessee",primary:"#FF8200",secondary:"#FFFFFF"},
  UTSA:{name:"UTSA",primary:"#0C2340",secondary:"#F15A22"},
  TEX:{name:"Texas",primary:"#BF5700",secondary:"#FFFFFF"}
};
...
function loadSlate(){
  /* Cache-bust so a freshly committed slate shows up without a hard reload. */
  return fetch("slate.json?t=" + Date.now(), {cache: "no-store"})
    .then(function(r){
...
function refreshPicks(){
  return loadPicks(STATE.season).then(function(rows){
    var before = entriesFingerprint();
    var me = getPlayer();
    var mine = STATE.entries[me.id];
    ALL_ROWS = rows;
    rebuildState();
    if (mine && entryIsNewer(mine, STATE.entries[me.id])) STATE.entries[me.id] = mine;
    if (entriesFingerprint() === before) return;          // nothing new to show
...
function renderShell(player){
  ...
  '<div class="topbar safe-top">' +
    '<div class="brand">🏈 <span>CFB Pick’em</span>' +
